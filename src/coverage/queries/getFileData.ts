...
export default async function getFileData(
  ...
  if (!args.groupName || !args.projectName || !args.branchName || !args.path) return undefined

  return getGithubFileData(args.groupName, args.projectName, args.branchName, args.path)
}
