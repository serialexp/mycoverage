...
export class CoberturaCoverage {
  ...
  async init(data: string, sourceHits: SourceHits = {}, repositoryRoot?: string): Promise<void> {
    return new Promise((resolve, reject) => {
      parseString(data, (err, result) => {
        ...
        CoberturaCoverage.updateMetrics(validatedData)
