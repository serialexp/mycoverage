...
export function lineInformation_LineTypeFromJSON(object: any): LineInformation_LineType {
  switch (object) {
    case 0:
    case "STATEMENT":
...
export function lineInformation_LineTypeToJSON(object: LineInformation_LineType): string {
  switch (object) {
...
export const Coverage = {
  encode(message: Coverage, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromJSON(object: any): Coverage {
    ...
    message.lineInfo = (object.lineInfo ?? []).map((e: any) => LineInformation.fromJSON(e))
    return message
  },
  ...
  toJSON(message: Coverage): unknown {
    ...
    if (message.lineInfo) {
      obj.lineInfo = message.lineInfo.map((e) => (e ? LineInformation.toJSON(e) : undefined))
    } else {
      obj.lineInfo = []
    }
    return obj
  ...
  fromPartial<I extends Exact<DeepPartial<Coverage>, I>>(object: I): Coverage {
    ...
    message.lineInfo = object.lineInfo?.map((e) => LineInformation.fromPartial(e)) || []
    return message
  },
}

function createBaseLineInformation(): LineInformation {
  return { type: 0, hits: 0, branches: 0, coveredBranches: 0, hitsBySource: [], lineNumber: 0 }
}

export const LineInformation = {
  encode(message: LineInformation, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.type !== 0) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break
        case 5:
          message.hitsBySource.push(HitsBySource.decode(reader, reader.uint32()))
          break
        case 6:
  ...
  fromJSON(object: any): LineInformation {
    ...
    message.type =
      object.type !== undefined && object.type !== null
        ...
        : 0
    message.hits = object.hits !== undefined && object.hits !== null ? Number(object.hits) : 0
    message.branches =
      object.branches !== undefined && object.branches !== null ? Number(object.branches) : 0
    message.coveredBranches =
      object.coveredBranches !== undefined && object.coveredBranches !== null
        ? Number(object.coveredBranches)
        : 0
    message.hitsBySource = (object.hitsBySource ?? []).map((e: any) => HitsBySource.fromJSON(e))
    message.lineNumber =
      object.lineNumber !== undefined && object.lineNumber !== null ? Number(object.lineNumber) : 0
    return message
  },

  toJSON(message: LineInformation): unknown {
    const obj: any = {}
    message.type !== undefined && (obj.type = lineInformation_LineTypeToJSON(message.type))
    message.hits !== undefined && (obj.hits = Math.round(message.hits))
    message.branches !== undefined && (obj.branches = Math.round(message.branches))
    message.coveredBranches !== undefined &&
      (obj.coveredBranches = Math.round(message.coveredBranches))
    if (message.hitsBySource) {
      obj.hitsBySource = message.hitsBySource.map((e) => (e ? HitsBySource.toJSON(e) : undefined))
    } else {
      obj.hitsBySource = []
    }
  ...
  fromPartial<I extends Exact<DeepPartial<LineInformation>, I>>(object: I): LineInformation {
    const message = createBaseLineInformation()
    message.type = object.type ?? 0
    message.hits = object.hits ?? 0
    message.branches = object.branches ?? 0
    message.coveredBranches = object.coveredBranches ?? 0
    message.hitsBySource = object.hitsBySource?.map((e) => HitsBySource.fromPartial(e)) || []
...
export const HitsBySource = {
  encode(message: HitsBySource, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromPartial<I extends Exact<DeepPartial<HitsBySource>, I>>(object: I): HitsBySource {
    const message = createBaseHitsBySource()
