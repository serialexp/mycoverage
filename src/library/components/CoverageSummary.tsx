		...
		<>
			<Flex m={4}>
				<Stat>
					...
					<StatNumber>
						{format.format(props.metrics.coveredPercentage)}%
					</StatNumber>
					<StatHelpText>
						<DiffHelper
				...
				<Stat>
					...
					<StatNumber>
						{format.format(props.metrics.coveredStatements)}
					</StatNumber>
					<StatHelpText>
						{props.baseMetrics ? (
							<DiffHelper
			...
			<Flex m={4}>
				<Stat>
					...
					<StatNumber>
						{format.format(props.metrics.coveredElements)}/
						{format.format(props.metrics.elements)}
					</StatNumber>
					<StatHelpText />
				</Stat>
				<Stat>
