...
export const ActivityIcon = (props: { activity: ChangeRate; rate: number }) => {
  ...
  switch (props.activity) {
    ...
    case ChangeRate.LOW:
      color = "green.500"
      icon = <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
      title = "Low activity"
      break
    ...
    case ChangeRate.HIGH:
      color = "red.500"
      icon = <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 15.75 7.5-7.5 7.5 7.5" />
      title = "High activity"
      break
