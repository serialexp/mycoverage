...
export const changefrequencyWorker = new Worker<{
  ...
  async (job) => {
    ...
    try {
      ...
      const ratePerPackage: Record<string, keyof typeof changeFrequencyMapping> = {}
            ...
            return db.fileCoverage
              .updateMany({
                ...
                data: {
                  changes: changeCount,
                  changeRate:
                    changeFrequencyMapping[postData.changes[changePath]?.rate ?? "medium"],
        ...
        Object.keys(changesPerPackage).map((packageId) => {
          ...
          return db.packageCoverage.update({
            ...
            data: {
              ...
              changeRate: rate ? changeFrequencyMapping[rate] : ChangeRate.MEDIUM,
