...
class DiffViewer extends React.Component<ReactDiffViewerProps, ReactDiffViewerState> {
  ...
  private renderDiff = (): JSX.Element[] => {
    const { oldValue, newValue, splitView, disableWordDiff, compareMethod, linesOffset } =
      this.props
  ...
  public render = (): JSX.Element => {
    const { oldValue, newValue, useDarkTheme, leftTitle, rightTitle, splitView, hideLineNumbers } =
      this.props
    ...
    const title = (leftTitle || rightTitle) && (
      <tr>
        ...
        {splitView && (
          <td colSpan={colSpanOnSplitView + columnExtension} className={this.styles.titleBlock}>
