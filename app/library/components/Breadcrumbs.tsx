...
export const Breadcrumbs = (props: Props) => {
  return (
    <Breadcrumb px={2} py={1} bg={"primary.100"} separator={<ChevronRightIcon color="gray.500" />}>
      {props.group ? (
        <BreadcrumbItem>
          <Link passHref={true} href={Routes.GroupPage({ groupId: props.group.slug })}>
      ...
      {props.project && props.group ? (
        <BreadcrumbItem>
          <Link
            passHref={true}
            href={Routes.ProjectPage({ groupId: props.group.slug, projectId: props.project.slug })}
          >
      ...
      {props.commit && props.project && props.group ? (
        <BreadcrumbItem>
          ...
          >
            <BreadcrumbLink href="#">{props.commit.ref.substr(0, 10)}</BreadcrumbLink>
          </Link>
        </BreadcrumbItem>
      ) : null}
